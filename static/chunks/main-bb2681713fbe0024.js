        ...
        return (
          ...
          i
            ...
            .then((r) => {
              ...
              ).then((t) => es({ ...e, err: s, Component: u, styleSheets: l, props: t }));
            })
        );
      }
      function J(e) {
        ...
        return (
          !(function (e, t) {
            ...
            et
              ...
              : ((et = y.default.hydrateRoot(e, r, { onRecoverableError: k.onRecoverableError })),
                (er = !1));
        ...
        async change(e, t, r, n, o) {
          ...
          try {
            ...
            if (
              ...
              !(B && !g && !X && !Z && (0, A.compareRouterStates)(y, this.state)))
            ) {
              try {
                await this.set(y, a, g);
              } catch (e) {
          ...
          try {
            ...
            if (
              ...
              (null == T ? void 0 : null == (P = T.effect) ? void 0 : P.type) ===
                'redirect-internal' ||
                (null == T ? void 0 : null == (b = T.effect) ? void 0 : b.type) ===
                  'redirect-external')
            )
              return T.effect;
            if ((null == T ? void 0 : null == (v = T.effect) ? void 0 : v.type) === 'rewrite') {
    ...
    31242: (e, t, r) => {
      ...
      function a(e, t, r) {
        ...
        let a = new URL((0, n.getLocationOrigin)()),
          ...
          { pathname: s, searchParams: u, search: l, hash: c, href: f, origin: d } = new URL(e, i);
